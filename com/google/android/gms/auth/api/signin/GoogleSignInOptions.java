...
public class GoogleSignInOptions extends zza implements Optional, ReflectedParcelable {
    ...
    private static Comparator<Scope> zzajc = new C02201();
    ...
    class C02201 implements Comparator<Scope> {
        C02201() {
        }
    ...
    public static GoogleSignInOptions zzcw(String str) throws JSONException {
