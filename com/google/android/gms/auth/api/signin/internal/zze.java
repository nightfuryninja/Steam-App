...
public final class zze {
    ...
    class C02233 extends zza<Status> {

        class C02221 extends zza {
            final /* synthetic */ C02233 zzajx;

            C02221(C02233 c02233) {
                this.zzajx = c02233;
            }
        ...
        C02233(GoogleApiClient googleApiClient) {
            super(googleApiClient);
        }

        protected void zza(zzd com_google_android_gms_auth_api_signin_internal_zzd) throws RemoteException {
            ((zzi) com_google_android_gms_auth_api_signin_internal_zzd.zzwW()).zzc(new C02221(this), com_google_android_gms_auth_api_signin_internal_zzd.zzqU());
        }
    ...
    public static PendingResult<Status> zzb(GoogleApiClient googleApiClient, Context context) {
        ...
        return googleApiClient.zzb(new C02233(googleApiClient));
    }
}
