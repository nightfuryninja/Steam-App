...
public class zzf extends ArrayAdapter<MediaTrack> implements OnClickListener {
    ...
    public zzf(Context context, List<MediaTrack> list, int i) {
        List arrayList;
        int i2 = C0154R.layout.cast_tracks_chooser_dialog_row_layout;
        if (list == null) {
    ...
    private String zza(MediaTrack mediaTrack, int i) {
        ...
        if (mediaTrack.getSubtype() == 2) {
            return this.mContext.getString(C0154R.string.cast_tracks_chooser_dialog_closed_captions);
        }
        ...
        return this.mContext.getString(C0154R.string.cast_tracks_chooser_dialog_default_track_name, new Object[]{Integer.valueOf(i + 1)});
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View view2;
        if (view == null) {
            view = ((LayoutInflater) this.mContext.getSystemService("layout_inflater")).inflate(C0154R.layout.cast_tracks_chooser_dialog_row_layout, viewGroup, false);
            com_google_android_gms_cast_framework_media_zzf_zza = new zza((TextView) view.findViewById(C0154R.id.text), (RadioButton) view.findViewById(C0154R.id.radio));
