...
public abstract class ExpandedControllerActivity extends AppCompatActivity {
    ...
    class C02441 implements com.google.android.gms.internal.zzxa.zza {
        final /* synthetic */ ExpandedControllerActivity zzatL;

        C02441(ExpandedControllerActivity expandedControllerActivity) {
    ...
    private class zza implements Listener {
        ...
        public void onSendingRemoteMediaRequest() {
            this.zzatL.zzatz.setText(this.zzatL.getResources().getString(C0154R.string.cast_expanded_controller_loading));
        }
    ...
    private zzxf zza(RelativeLayout relativeLayout) {
        ...
        layoutParams.addRule(0, C0154R.id.end_text);
        layoutParams.addRule(1, C0154R.id.start_text);
        layoutParams.addRule(6, C0154R.id.seek_bar);
        layoutParams.addRule(7, C0154R.id.seek_bar);
        layoutParams.addRule(5, C0154R.id.seek_bar);
        layoutParams.addRule(8, C0154R.id.seek_bar);
        ...
        com_google_android_gms_internal_zzxf.setContentDescription(getResources().getString(C0154R.string.cast_seek_bar));
    ...
    private void zza(Toolbar toolbar) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setHomeAsUpIndicator(C0154R.drawable.quantum_ic_keyboard_arrow_down_white_36);
        }
    }

    private void zza(View view, int i, int i2, UIMediaController uIMediaController) {
        ImageView imageView = (ImageView) view.findViewById(i);
        if (i2 == C0154R.id.cast_button_type_empty) {
            imageView.setVisibility(4);
        } else if (i2 == C0154R.id.cast_button_type_custom) {
        } else {
            if (i2 == C0154R.id.cast_button_type_play_pause_toggle) {
                zza(imageView, uIMediaController);
            } else if (i2 == C0154R.id.cast_button_type_skip_previous) {
                zzb(imageView, uIMediaController);
            } else if (i2 == C0154R.id.cast_button_type_skip_next) {
                zzc(imageView, uIMediaController);
            } else if (i2 == C0154R.id.cast_button_type_rewind_30_seconds) {
                zzd(imageView, uIMediaController);
            } else if (i2 == C0154R.id.cast_button_type_forward_30_seconds) {
                zze(imageView, uIMediaController);
            } else if (i2 == C0154R.id.cast_button_type_mute_toggle) {
                zzf(imageView, uIMediaController);
            } else if (i2 == C0154R.id.cast_button_type_closed_caption) {
    ...
    private void zza(View view, UIMediaController uIMediaController) {
        this.zzatA = (ImageView) view.findViewById(C0154R.id.background_image_view);
        this.zzatB = (ImageView) view.findViewById(C0154R.id.blurred_background_image_view);
        View findViewById = view.findViewById(C0154R.id.background_place_holder_image_view);
        ...
        this.zzatz = (TextView) view.findViewById(C0154R.id.status_text);
        uIMediaController.bindViewToLoadingIndicator((ProgressBar) view.findViewById(C0154R.id.loading_indicator));
        TextView textView = (TextView) view.findViewById(C0154R.id.start_text);
        TextView textView2 = (TextView) view.findViewById(C0154R.id.end_text);
        ImageView imageView = (ImageView) view.findViewById(C0154R.id.live_stream_indicator);
        this.zzasI = (SeekBar) view.findViewById(C0154R.id.seek_bar);
        zztF();
        zztH();
        SeekBar seekBar = (SeekBar) view.findViewById(C0154R.id.live_stream_seek_bar);
        ...
        this.zzatE[0] = (ImageView) view.findViewById(C0154R.id.button_0);
        this.zzatE[1] = (ImageView) view.findViewById(C0154R.id.button_1);
        this.zzatE[2] = (ImageView) view.findViewById(C0154R.id.button_2);
        this.zzatE[3] = (ImageView) view.findViewById(C0154R.id.button_3);
        zza(view, C0154R.id.button_0, this.zzatD[0], uIMediaController);
        zza(view, C0154R.id.button_1, this.zzatD[1], uIMediaController);
        zza(view, C0154R.id.button_play_pause_toggle, C0154R.id.cast_button_type_play_pause_toggle, uIMediaController);
        zza(view, C0154R.id.button_2, this.zzatD[2], uIMediaController);
        zza(view, C0154R.id.button_3, this.zzatD[3], uIMediaController);
        this.zzatF = findViewById(C0154R.id.ad_container);
        this.zzatG = (ImageView) this.zzatF.findViewById(C0154R.id.ad_image_view);
        this.zzatI = (TextView) this.zzatF.findViewById(C0154R.id.ad_label);
        this.zzatH = (TextView) this.zzatF.findViewById(C0154R.id.ad_in_progress_label);
        this.zzatC = zza((RelativeLayout) view.findViewById(C0154R.id.seek_bar_controls));
    }
    ...
    private void zzb(ImageView imageView, UIMediaController uIMediaController) {
        ...
        imageView.setContentDescription(getResources().getString(C0154R.string.cast_skip_prev));
    ...
    private void zzc(ImageView imageView, UIMediaController uIMediaController) {
        ...
        imageView.setContentDescription(getResources().getString(C0154R.string.cast_skip_next));
    ...
    private void zzd(ImageView imageView, UIMediaController uIMediaController) {
        ...
        imageView.setContentDescription(getResources().getString(C0154R.string.cast_rewind_30));
    ...
    private void zze(ImageView imageView, UIMediaController uIMediaController) {
        ...
        imageView.setContentDescription(getResources().getString(C0154R.string.cast_forward_30));
    ...
    private void zztD() {
        TypedArray obtainStyledAttributes = obtainStyledAttributes(new int[]{C0098R.attr.selectableItemBackgroundBorderless, C0098R.attr.colorControlActivated});
    ...
    private void zztE() {
        boolean z = true;
        TypedArray obtainStyledAttributes = obtainStyledAttributes(null, C0154R.styleable.CastExpandedController, C0154R.attr.castExpandedControllerStyle, C0154R.style.CastExpandedController);
        this.zzaty = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castButtonColor, 0);
        this.zzatn = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castSeekBarProgressDrawable, 0);
        this.zzato = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castSeekBarThumbDrawable, 0);
        this.zzatp = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castPlayButtonDrawable, 0);
        this.zzatq = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castPauseButtonDrawable, 0);
        this.zzatr = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castStopButtonDrawable, 0);
        this.zzats = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castSkipPreviousButtonDrawable, 0);
        this.zzatt = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castSkipNextButtonDrawable, 0);
        this.zzatu = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castRewind30ButtonDrawable, 0);
        this.zzatv = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castForward30ButtonDrawable, 0);
        this.zzatw = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castMuteToggleButtonDrawable, 0);
        this.zzatx = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castClosedCaptionsButtonDrawable, 0);
        int resourceId = obtainStyledAttributes.getResourceId(C0154R.styleable.CastExpandedController_castControlButtons, 0);
        if (resourceId != 0) {
            ...
            this.zzatD = new int[]{C0154R.id.cast_button_type_empty, C0154R.id.cast_button_type_empty, C0154R.id.cast_button_type_empty, C0154R.id.cast_button_type_empty};
        }
        obtainStyledAttributes.recycle();
    }
    ...
    private void zztF() {
        ...
        if (drawable != null) {
            if (this.zzatn == C0154R.drawable.cast_expanded_controller_seekbar_track) {
                ...
                layerDrawable.findDrawableByLayerId(16908288).setColorFilter(getResources().getColor(C0154R.color.cast_expanded_controller_seek_bar_progress_background_tint_color), Mode.SRC_IN);
                colorStateList = zztG;
            }
        ...
        if (drawable != null) {
            if (this.zzato == C0154R.drawable.cast_expanded_controller_seekbar_thumb) {
    ...
    private ColorStateList zztG() {
        ...
        getResources().getValue(C0154R.dimen.cast_expanded_controller_seekbar_disabled_alpha, typedValue, true);
        ...
        if (currentCastSession != null) {
            ...
            if (castDevice != null) {
                if (!TextUtils.isEmpty(castDevice.getFriendlyName())) {
                    this.zzatz.setText(getResources().getString(C0154R.string.cast_casting_to_device, new Object[]{r0}));
                    return;
                }
            }
        }
    ...
    private void zztL() {
        ...
        if (z) {
            ...
            if (TextUtils.isEmpty(charSequence)) {
                charSequence = getResources().getString(C0154R.string.cast_ad_label);
            }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C0154R.layout.cast_expanded_controller_activity);
        zztD();
        zztE();
        zza(findViewById(C0154R.id.expanded_controller_layout), this.zzatK);
        zza((Toolbar) findViewById(C0154R.id.toolbar));
        zztK();
        zztJ();
        this.zzatJ = new zzxa(getApplicationContext(), new ImageHints(-1, this.zzatG.getWidth(), this.zzatG.getHeight()));
        this.zzatJ.zza(new C02441(this));
    }
