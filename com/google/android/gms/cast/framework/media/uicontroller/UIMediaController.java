...
public class UIMediaController implements SessionManagerListener<CastSession>, Listener {
    ...
    class C02431 implements OnSeekBarChangeListener {
        final /* synthetic */ UIMediaController zzass;

        C02431(UIMediaController uIMediaController) {
    ...
    public void bindSeekBar(SeekBar seekBar, long j) {
        zzac.zzdn("Must be called from the main thread.");
        zza(seekBar, new zzxr(seekBar, j, new C02431(this)));
    }

    public void bindTextViewToStreamDuration(TextView textView, View view) {
        zzac.zzdn("Must be called from the main thread.");
        zza(textView, new zzxv(textView, this.mActivity.getString(C0154R.string.cast_invalid_stream_duration_text), view));
    }
    ...
    public void bindTextViewToStreamPosition(TextView textView, boolean z, long j) {
        zzac.zzdn("Must be called from the main thread.");
        UIController com_google_android_gms_internal_zzxw = new zzxw(textView, j, this.mActivity.getString(C0154R.string.cast_invalid_stream_position_text));
        if (z) {
