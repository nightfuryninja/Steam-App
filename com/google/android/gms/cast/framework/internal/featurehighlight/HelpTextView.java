...
public class HelpTextView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.zzaqp = (TextView) zzbir.zzw((TextView) findViewById(C0154R.id.cast_featurehighlight_help_text_header_view));
        this.zzaqq = (TextView) zzbir.zzw((TextView) findViewById(C0154R.id.cast_featurehighlight_help_text_body_view));
    }
