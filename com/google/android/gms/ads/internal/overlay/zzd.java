...
public class zzd extends zzj implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C01591 implements Runnable {
        ...
        C01591(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    class C01602 implements Runnable {
        ...
        C01602(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C01624 implements Runnable {
        ...
        C01624(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C01646 implements Runnable {
        final /* synthetic */ zzd zzMs;

        C01646(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C01657 implements Runnable {
        final /* synthetic */ zzd zzMs;

        C01657(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C01668 implements Runnable {
        final /* synthetic */ zzd zzMs;

        C01668(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzMs = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    private void zzhe() {
        Throwable e;
        String valueOf;
        zzpe.m11v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzhf() {
        if (this.zzMe && zzhg() && this.zzMh.getCurrentPosition() > 0 && this.zzMg != 3) {
            zzpe.m11v("AdMediaPlayerView nudging MediaPlayer");
            zza(0.0f);
            this.zzMh.start();
    ...
    private void zzy(boolean z) {
        zzpe.m11v("AdMediaPlayerView release");
        if (this.zzMo != null) {
            this.zzMo.zzhP();
            this.zzMo = null;
        }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        zzpe.m11v("AdMediaPlayerView completion");
        zzI(5);
        zzJ(5);
        zzpi.zzWR.post(new C01602(this));
    }
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzpe.m11v(new StringBuilder((String.valueOf(str).length() + 37) + String.valueOf(str2).length()).append("AdMediaPlayerView MediaPlayer info: ").append(str).append(":").append(str2).toString());
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzpe.m11v("AdMediaPlayerView prepared");
        zzI(2);
        this.zzMd.zzhz();
        zzpi.zzWR.post(new C01591(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzpe.m11v("AdMediaPlayerView surface created");
        zzhe();
        zzpi.zzWR.post(new C01624(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzpe.m11v("AdMediaPlayerView surface destroyed");
        ...
        zzpi.zzWR.post(new C01646(this));
        zzy(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, final int i, final int i2) {
        Object obj = 1;
        zzpe.m11v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzpe.m11v("AdMediaPlayerView size changed: " + i + " x " + i2);
        this.zzMj = mediaPlayer.getVideoWidth();
        this.zzMk = mediaPlayer.getVideoHeight();
    ...
    public void pause() {
        zzpe.m11v("AdMediaPlayerView pause");
        if (zzhg() && this.zzMh.isPlaying()) {
            this.zzMh.pause();
            zzI(4);
            zzpi.zzWR.post(new C01668(this));
        }
        zzJ(4);
    }

    public void play() {
        zzpe.m11v("AdMediaPlayerView play");
        if (zzhg()) {
            this.zzMh.start();
            zzI(3);
            this.zzNj.zzhA();
            zzpi.zzWR.post(new C01657(this));
        }
        zzJ(3);
    }

    public void seekTo(int i) {
        zzpe.m11v("AdMediaPlayerView seek " + i);
        if (zzhg()) {
            this.zzMh.seekTo(i);
            this.zzMq = 0;
            return;
    ...
    public void stop() {
        zzpe.m11v("AdMediaPlayerView stop");
        if (this.zzMh != null) {
            this.zzMh.stop();
            this.zzMh.release();
            this.zzMh = null;
