...
class zzx implements SensorEventListener {
    ...
    class C01731 implements Runnable {
        C01731(zzx com_google_android_gms_ads_internal_overlay_zzx) {
        }
    ...
    void start() {
        if (this.zzNM == null) {
            ...
            if (defaultSensor == null) {
                zzpy.m10e("No Sensor of TYPE_ROTATION_VECTOR");
                return;
            }
            ...
            if (!this.zzNG.registerListener(this, defaultSensor, 0, this.zzNM)) {
                zzpy.m10e("SensorManager.registerListener failed.");
                stop();
            }
        }
    }
    ...
    void stop() {
        if (this.zzNM != null) {
            ...
            this.zzNM.post(new C01731(this));
            this.zzNM = null;
        }
    }
