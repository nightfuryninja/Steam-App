...
public class zzg {
    ...
    public final zzhx zzsX = new C01881(this);

    class C01881 implements zzhx {
        final /* synthetic */ zzg zzsY;

        C01881(zzg com_google_android_gms_ads_internal_zzg) {
    ...
    public void zza(Context context, zzqa com_google_android_gms_internal_zzqa, boolean z, zzox com_google_android_gms_internal_zzox, String str, String str2) {
        ...
        if (context == null) {
            ...
            zzpi.zzWR.post(new Runnable(this) {
                ...
                class C01891 implements zzc<zzjb> {
                    final /* synthetic */ C01902 zzte;

                    C01891(C01902 c01902) {
                        this.zzte = c01902;
                    }
                ...
                public void run() {
                    zzd.zzgv().zza(new C01891(this), new zzb());
                }
            });
        }
    }
