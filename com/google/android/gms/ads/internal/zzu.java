...
public class zzu extends com.google.android.gms.internal.zzep.zza {
    ...
    class C02041 extends WebViewClient {
        final /* synthetic */ zzu zzus;

        C02041(zzu com_google_android_gms_ads_internal_zzu) {
    ...
    class C02052 implements OnTouchListener {
        final /* synthetic */ zzu zzus;

        C02052(zzu com_google_android_gms_ads_internal_zzu) {
            this.zzus = com_google_android_gms_ads_internal_zzu;
        }
    ...
    class C02063 implements Callable<zzch> {
        final /* synthetic */ zzu zzus;

        C02063(zzu com_google_android_gms_ads_internal_zzu) {
            this.zzus = com_google_android_gms_ads_internal_zzu;
        }
    ...
    private void zzcw() {
        ...
        this.zzup.setWebViewClient(new C02041(this));
        this.zzup.setOnTouchListener(new C02052(this));
    }

    private Future<zzch> zzcz() {
        return zzph.zza(new C02063(this));
    }
