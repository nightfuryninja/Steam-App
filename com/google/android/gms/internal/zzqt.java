...
class zzqt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzqp {
    ...
    class C07151 implements zzhx {
        final /* synthetic */ zzqt zzZu;

        C07151(zzqt com_google_android_gms_internal_zzqt) {
    ...
    class C07162 implements Runnable {
        ...
        C07162(zzqt com_google_android_gms_internal_zzqt) {
            this.zzZu = com_google_android_gms_internal_zzqt;
        }
    ...
    public void destroy() {
        synchronized (this.zzrN) {
            ...
            zzlI();
            this.zzZc = true;
            zzpe.m11v("Initiating WebView self destruct sequence in 3...");
            this.zzYZ.zzls();
        }
    }
    ...
    public void zza(zzqu com_google_android_gms_internal_zzqu) {
        synchronized (this.zzrN) {
            if (this.zzZi != null) {
                zzpy.m10e("Attempt to create multiple AdWebViewVideoControllers.");
                return;
            }
    ...
    public void zzla() {
        synchronized (this.zzrN) {
            zzpe.m11v("Destroying WebView!");
            zzpi.zzWR.post(new C07162(this));
        }
    }
