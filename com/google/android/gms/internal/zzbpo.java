...
public class zzbpo {
    ...
    private static zzbpn zzchU = new C04271();
    ...
    private final Thread zzchS = getThreadFactory().newThread(new C04282(this));

    class C04271 implements zzbpn {
        C04271() {
        }
    ...
    class C04282 implements Runnable {
        ...
        C04282(zzbpo com_google_android_gms_internal_zzbpo) {
