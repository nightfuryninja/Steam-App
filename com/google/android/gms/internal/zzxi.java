...
public class zzxi extends UIController {
    ...
    class C07501 implements zza {
        final /* synthetic */ zzxi zzasE;

        C07501(zzxi com_google_android_gms_internal_zzxi) {
            this.zzasE = com_google_android_gms_internal_zzxi;
        }
    ...
    public void onSessionConnected(CastSession castSession) {
        ...
        this.zzasA.zza(new C07501(this));
        zzty();
        zztx();
    }
