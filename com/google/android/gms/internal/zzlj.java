...
public abstract class zzlj implements zzpk<Void>, zza {
    ...
    class C06281 implements Runnable {
        ...
        C06281(zzlj com_google_android_gms_internal_zzlj) {
            this.zzPt = com_google_android_gms_internal_zzlj;
        }

        public void run() {
            if (this.zzPt.zzPs.get()) {
                zzpy.m10e("Timed out waiting for WebView to finish loading.");
                this.zzPt.cancel();
            }
        }
    }
