...
public class zzde {
    ...
    class C05081 implements Comparator<com.google.android.gms.internal.zzdh.zza> {
        C05081(zzde com_google_android_gms_internal_zzde) {
        }
    ...
    String zzG(String str) {
        ...
        zza zzep = zzep();
        PriorityQueue priorityQueue = new PriorityQueue(this.zzyd, new C05081(this));
