...
public class zzaye {
    ...
    class C03581 implements zza {
        final /* synthetic */ zzaye zzbHi;

        C03581(zzaye com_google_android_gms_internal_zzaye) {
    ...
    class C03592 implements Runnable {
        ...
        C03592(zzaye com_google_android_gms_internal_zzaye) {
            this.zzbHi = com_google_android_gms_internal_zzaye;
        }
    ...
    public zzaye(Context context, zza com_google_android_gms_internal_zzaye_zza, zze com_google_android_gms_common_util_zze) {
        ...
        this.zzWx = new Thread(new C03592(this));
    }
