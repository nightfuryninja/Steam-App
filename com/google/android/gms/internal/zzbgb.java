...
public final class zzbgb extends zzbfw<List<zzbfw<?>>> {
    ...
    class C04021 implements Iterator<zzbfw<?>> {
        private int zzbKZ = 0;
        final /* synthetic */ zzbgb zzbLa;

        C04021(zzbgb com_google_android_gms_internal_zzbgb) {
    ...
    public Iterator<zzbfw<?>> zzRE() {
        final Iterator c04021 = new C04021(this);
        final Iterator zzRG = super.zzRG();
        return new Iterator<zzbfw<?>>(this) {
            public boolean hasNext() {
                return c04021.hasNext() || zzRG.hasNext();
            }
            ...
            public zzbfw<?> zzRH() {
                return c04021.hasNext() ? (zzbfw) c04021.next() : (zzbfw) zzRG.next();
            }
        };
    }
