...
public class zzlv {
    ...
    class C06472 implements zzhx {
        final /* synthetic */ zzlv zzQE;

        C06472(zzlv com_google_android_gms_internal_zzlv) {
    ...
    private void zzj(zzqp com_google_android_gms_internal_zzqp) {
        ...
        zzkV.zza("/trackActiveViewUnit", new C06472(this));
    }
    ...
    public zzqf<zzqp> zzf(final JSONObject jSONObject) {
        ...
        zzv.zzcJ().runOnUiThread(new Runnable(this) {
            ...
            class C06452 implements zzqq.zza {
                final /* synthetic */ C06461 zzQF;

                C06452(C06461 c06461) {
                    this.zzQF = c06461;
                }
