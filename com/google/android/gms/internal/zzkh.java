...
public class zzkh implements MediationInterstitialAdapter {
    ...
    class C06171 implements zza {
        C06171(zzkh com_google_android_gms_internal_zzkh) {
        }
    }

    class C06182 implements zzh {
        final /* synthetic */ zzkh zzLj;

        C06182(zzkh com_google_android_gms_internal_zzkh) {
    ...
    public void showInterstitial() {
        ...
        final AdOverlayInfoParcel adOverlayInfoParcel = new AdOverlayInfoParcel(new zzc(build.intent), null, new C06182(this), null, new zzqa(0, 0, false));
