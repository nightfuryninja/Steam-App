...
public final class zzbrl {
    ...
    class C04361 implements zzbrp {
        final /* synthetic */ zzbrl zzcmB;

        C04361(zzbrl com_google_android_gms_internal_zzbrl) {
            this.zzcmB = com_google_android_gms_internal_zzbrl;
        }
    }

    class C04372 implements zzbry {
        final /* synthetic */ zzbrl zzcmB;

        C04372(zzbrl com_google_android_gms_internal_zzbrl) {
            this.zzcmB = com_google_android_gms_internal_zzbrl;
        }
    }

    class C04383 extends zzbsd<Number> {
        final /* synthetic */ zzbrl zzcmB;

        C04383(zzbrl com_google_android_gms_internal_zzbrl) {
            this.zzcmB = com_google_android_gms_internal_zzbrl;
        }
    ...
    class C04394 extends zzbsd<Number> {
        final /* synthetic */ zzbrl zzcmB;

        C04394(zzbrl com_google_android_gms_internal_zzbrl) {
            this.zzcmB = com_google_android_gms_internal_zzbrl;
        }
    ...
    class C04405 extends zzbsd<Number> {
        final /* synthetic */ zzbrl zzcmB;

        C04405(zzbrl com_google_android_gms_internal_zzbrl) {
            this.zzcmB = com_google_android_gms_internal_zzbrl;
        }
    ...
    zzbrl(zzbsm com_google_android_gms_internal_zzbsm, zzbrk com_google_android_gms_internal_zzbrk, Map<Type, zzbrn<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, zzbsb com_google_android_gms_internal_zzbsb, List<zzbse> list) {
        ...
        this.zzcmz = new C04361(this);
        this.zzcmA = new C04372(this);
    ...
    private zzbsd<Number> zza(zzbsb com_google_android_gms_internal_zzbsb) {
        return com_google_android_gms_internal_zzbsb == zzbsb.DEFAULT ? zzbtg.zzcoN : new C04405(this);
    }
    ...
    private zzbsd<Number> zzbe(boolean z) {
        return z ? zzbtg.zzcoP : new C04383(this);
    }

    private zzbsd<Number> zzbf(boolean z) {
        return z ? zzbtg.zzcoO : new C04394(this);
    }
