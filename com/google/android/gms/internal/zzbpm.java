...
class zzbpm {
    ...
    static class zzc implements zzb {
        private static ThreadLocal<CharsetDecoder> zzchG = new C04251();
        private static ThreadLocal<CharsetEncoder> zzchH = new C04262();
        private StringBuilder zzchI = new StringBuilder();

        class C04251 extends ThreadLocal<CharsetDecoder> {
            C04251() {
            }
        ...
        class C04262 extends ThreadLocal<CharsetEncoder> {
            C04262() {
            }
