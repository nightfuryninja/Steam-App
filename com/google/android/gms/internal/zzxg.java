...
public class zzxg extends UIController {
    ...
    private final OnClickListener zzasw = new C07491(this);

    class C07491 implements OnClickListener {
        final /* synthetic */ zzxg zzasx;

        C07491(zzxg com_google_android_gms_internal_zzxg) {
            this.zzasx = com_google_android_gms_internal_zzxg;
        }
    ...
    public zzxg(View view, Activity activity) {
        this.mView = view;
        this.zzasu = activity.getString(C0154R.string.cast_closed_captions);
        this.zzasv = activity.getString(C0154R.string.cast_closed_captions_unavailable);
