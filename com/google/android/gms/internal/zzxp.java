...
public class zzxp extends UIController {
    ...
    class C07541 implements OnClickListener {
        ...
        C07541(zzxp com_google_android_gms_internal_zzxp) {
            this.zzasV = com_google_android_gms_internal_zzxp;
        }
    ...
    public zzxp(ImageView imageView, Context context, Drawable drawable, Drawable drawable2, Drawable drawable3, View view, boolean z) {
        ...
        this.zzasQ = context.getString(C0154R.string.cast_play);
        this.zzasS = context.getString(C0154R.string.cast_pause);
        this.zzasU = context.getString(C0154R.string.cast_stop);
        this.zzasN = view;
        this.zzasO = z;
        this.zzasw = new C07541(this);
    }
