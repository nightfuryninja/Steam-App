...
public class zzbez extends zzazv {
    ...
    private void zza(Tracker tracker, zzbfw<?> com_google_android_gms_internal_zzbfw_, zzbfw<?> com_google_android_gms_internal_zzbfw_2, zzbfw<?> com_google_android_gms_internal_zzbfw_3) {
        ...
        if (str == null) {
            zzayx.m8e("Cannot find transactionId in data layer.");
            return;
        }
            ...
            if (zzhS != null) {
                for (Map map : zzhS) {
                    if (map.get("name") == null) {
                        zzayx.m8e("Unable to send transaction item hit due to missing 'name' field.");
                        return;
                    }
            ...
            if (obj instanceof List) {
                for (Map zzi2 : (List) obj) {
                    try {
                        ...
                        zzayx.m8e(str2.length() != 0 ? str3.concat(str2) : new String(str3));
                    }
                }
            }
            List list2 = null;
            ...
            if (r1 != null) {
                for (Map zzi22 : r1) {
                    try {
                        ...
                        zzayx.m8e(str2.length() != 0 ? str.concat(str2) : new String(str));
                    }
                }
                if (map.containsKey("promoClick")) {
                        ...
                        for (String str22 : zzbGY) {
                            if (map.containsKey(str22)) {
                                ...
                                try {
                                    ...
                                    zzayx.m8e(valueOf2.length() != 0 ? str22.concat(valueOf2) : new String(str22));
                                }
                            }
                        }
                    }
