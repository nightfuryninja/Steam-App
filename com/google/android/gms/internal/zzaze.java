...
public class zzaze {
    ...
    private zzbdp zzbIp;
    private zzaym zzbIq;
    private final zzc zzbIr = new C03641(this);

    public interface zzc {
        zzaym zzQK();
    }

    class C03641 implements zzc {
        final /* synthetic */ zzaze zzbIs;

        C03641(zzaze com_google_android_gms_internal_zzaze) {
    ...
    private class zza implements com.google.android.gms.internal.zzbdb.zza {
        ...
        public Object zze(String str, Map<String, Object> map) {
            try {
                ...
                zzayx.m8e(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
            }
            return null;
        }
    }
    ...
    private String zzC(String str, int i) {
        switch (i) {
            case 12:
                return zzhO(str);
            default:
                zzayx.m8e("Unsupported Value Escaping: " + i);
                return str;
        }
    }
    ...
    private zzbfw zzao(Map<String, zzbfw<?>> map) {
        if (map == null) {
            zzayx.m8e("Cannot access the function parameters.");
            return zzbga.zzbKV;
        }
        ...
        if (com_google_android_gms_internal_zzbfw instanceof zzbge) {
            ...
            if (this.zzbIl.has(str)) {
                ...
                zzayx.m8e(new StringBuilder(String.valueOf(str).length() + 30).append("functionId '").append(str).append("' is not supported").toString());
                return zzbga.zzbKV;
            }
            if (com_google_android_gms_internal_zzbgd == null) {
                zzayx.m8e("Internal error: failed to convert function to a valid statement");
                return zzbga.zzbKV;
            }
            String str2 = "Executing: ";
            str = String.valueOf(com_google_android_gms_internal_zzbgd.zzRR());
            zzayx.m9v(str.length() != 0 ? str2.concat(str) : new String(str2));
            ...
            zzayx.m8e("No function id in properties");
            return zzbga.zzbKV;
        }
    }
    ...
    private zzbfw<?> zzhM(String str) {
        ...
        zzayx.m9v(new StringBuilder((String.valueOf(valueOf).length() + 31) + String.valueOf(str).length()).append(valueOf).append("Beginning to evaluate variable ").append(str).toString());
        ...
        valueOf2 = String.valueOf(zzPK());
        zzayx.m9v(new StringBuilder((String.valueOf(valueOf2).length() + 25) + String.valueOf(str).length()).append(valueOf2).append("Done evaluating variable ").append(str).toString());
        this.zzbFM--;
        this.zzbIo.remove(str);
        return zzao;
    }
    ...
    private zzbgd zzi(String str, Map<String, zzbfw<?>> map) {
        try {
            ...
            String valueOf = String.valueOf(e.getMessage());
            zzayx.m8e(new StringBuilder((String.valueOf(str).length() + 30) + String.valueOf(valueOf).length()).append("Incorrect keys for function ").append(str).append(". ").append(valueOf).toString());
            return null;
        }
    }
    ...
    zzbfw<?> zza(zzbft com_google_android_gms_internal_zzbft, Map<zzbfs, zzbfw<?>> map) {
        ...
        zzayx.m9v(new StringBuilder(String.valueOf(valueOf).length() + 19).append("Evaluating trigger ").append(valueOf).toString());
    ...
    zzbfw<?> zzb(zzbfs com_google_android_gms_internal_zzbfs) {
        ...
        try {
            ...
            zzayx.m8e("Predicate must return a boolean value");
            return new zzbfx(Boolean.valueOf(false));
        } catch (IllegalStateException e) {
            zzayx.m8e("Error evaluating predicate.");
            return zzbga.zzbKU;
        }
    }
    ...
    public void zzb(zzaym com_google_android_gms_internal_zzaym) {
        ...
        for (zzbft com_google_android_gms_internal_zzbft : this.zzbIk.zzRr()) {
            ...
            if (com_google_android_gms_internal_zzbft.zzRx().isEmpty() && com_google_android_gms_internal_zzbft.zzRy().isEmpty()) {
                ...
                zzayx.m9v(new StringBuilder(String.valueOf(valueOf2).length() + 64).append("Trigger is not being evaluated since it has no associated tags: ").append(valueOf2).toString());
            } else {
                ...
                if (zza == zzbga.zzbKU) {
                    ...
                    if (!com_google_android_gms_internal_zzbft.zzRy().isEmpty()) {
                        ...
                        zzayx.m9v(new StringBuilder(String.valueOf(valueOf).length() + 15).append("Blocking tags: ").append(valueOf).toString());
                        hashSet2.addAll(com_google_android_gms_internal_zzbft.zzRy());
                    }
                } else if (((Boolean) ((zzbfx) zza).zzRF()).booleanValue()) {
                    valueOf = String.valueOf(com_google_android_gms_internal_zzbft);
                    zzayx.m9v(new StringBuilder(String.valueOf(valueOf).length() + 19).append("Trigger is firing: ").append(valueOf).toString());
                    if (!com_google_android_gms_internal_zzbft.zzRx().isEmpty()) {
                        valueOf = String.valueOf(com_google_android_gms_internal_zzbft.zzRx());
                        zzayx.m9v(new StringBuilder(String.valueOf(valueOf).length() + 34).append("Adding tags to firing candidates: ").append(valueOf).toString());
                        hashSet.addAll(com_google_android_gms_internal_zzbft.zzRx());
                    }
                    if (!com_google_android_gms_internal_zzbft.zzRy().isEmpty()) {
                        valueOf = String.valueOf(com_google_android_gms_internal_zzbft.zzRy());
                        zzayx.m9v(new StringBuilder(String.valueOf(valueOf).length() + 24).append("Blocking disabled tags: ").append(valueOf).toString());
                        hashSet2.addAll(com_google_android_gms_internal_zzbft.zzRy());
                    }
                }
            }
        ...
        for (zzbfs com_google_android_gms_internal_zzbfs : hashSet) {
            ...
            zzayx.m9v(new StringBuilder(String.valueOf(valueOf3).length() + 21).append("Executing firing tag ").append(valueOf3).toString());
            try {
                ...
                if (zza(com_google_android_gms_internal_zzbfs)) {
                    ...
                    zzayx.m9v(new StringBuilder(String.valueOf(valueOf2).length() + 36).append("Tag configured to dispatch on fire: ").append(valueOf2).toString());
                }
                obj2 = obj;
            } catch (IllegalStateException e) {
                valueOf3 = "Error firing tag: ";
                valueOf2 = String.valueOf(e.getMessage());
                zzayx.m8e(valueOf2.length() != 0 ? valueOf3.concat(valueOf2) : new String(valueOf3));
                obj2 = obj;
            }
            obj = obj2;
        }
        ...
        if (com_google_android_gms_internal_zzaym.zzQs()) {
            ...
            zzayx.m9v(new StringBuilder(String.valueOf(valueOf2).length() + 35).append("Log passthrough event ").append(valueOf2).append(" to Firebase.").toString());
            try {
                ...
                zzayx.m8e(valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf));
            }
        } else {
            valueOf2 = String.valueOf(com_google_android_gms_internal_zzaym.zzQp());
            zzayx.m9v(new StringBuilder(String.valueOf(valueOf2).length() + 63).append("Non-passthrough event ").append(valueOf2).append(" doesn't get logged to Firebase directly.").toString());
        }
        if (obj != null) {
            zzayx.m9v("Dispatch called for dispatchOnFire tags.");
            dispatch();
        }
    }
