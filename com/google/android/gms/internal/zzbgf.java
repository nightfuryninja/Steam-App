        ...
        if (com_google_android_gms_internal_zzbfw_ instanceof zzbfy) {
            ...
            if (com_google_android_gms_internal_zzbfw_ instanceof zzbgb) {
                ...
                for (zzbfw zzl : (List) ((zzbgb) com_google_android_gms_internal_zzbfw_).zzRF()) {
                    Object zzl2 = zzl(zzl);
                    if (zzl2 == null) {
                        zzayx.m8e(String.format("Failure to convert a list element to object: %s (%s)", new Object[]{zzl, zzl.getClass().getCanonicalName()}));
                        return null;
                    }
                    arrayList.add(zzl2);
                }
                ...
                for (Entry entry : ((Map) ((zzbgc) com_google_android_gms_internal_zzbfw_).zzRF()).entrySet()) {
                    ...
                    if (zzl3 == null) {
                        zzayx.m8e(String.format("Failure to convert a map's value to object: %s (%s)", new Object[]{entry.getValue(), ((zzbfw) entry.getValue()).getClass().getCanonicalName()}));
                        return null;
                    }
                ...
                zzayx.m8e(new StringBuilder(String.valueOf(valueOf).length() + 49).append("Converting to Object from unknown abstract type: ").append(valueOf).toString());
                return null;
            }
        }
    }
