...
class zzaza implements zzays {
    ...
    class zza implements com.google.android.gms.internal.zzazl.zza {
        ...
        public void zzb(zzayo com_google_android_gms_internal_zzayo) {
            this.zzbId.zzu(com_google_android_gms_internal_zzayo.zzPi());
            zzayx.m9v("Permanent failure dispatching hitId: " + com_google_android_gms_internal_zzayo.zzPi());
        }
        ...
        public void zzc(zzayo com_google_android_gms_internal_zzayo) {
            ...
            if (zzPj == 0) {
                ...
                this.zzbId.zzu(com_google_android_gms_internal_zzayo.zzPi());
                zzayx.m9v("Giving up on failed hitId: " + com_google_android_gms_internal_zzayo.zzPi());
            }
        }
    }
    ...
    private void zzPv() {
        ...
        if (zzPw > 0) {
            List zzmV = zzmV(zzPw);
            zzayx.m9v("Store full, deleting " + zzmV.size() + " hits to make room.");
    ...
    private void zzb(long j, String str, String str2, String str3, Map<String, String> map, String str4) {
        ...
        if (zzhh != null) {
            ...
            try {
                ...
                zzayx.m9v(new StringBuilder(String.valueOf(str).length() + 19).append("Hit stored (url = ").append(str).append(")").toString());
                this.zzbIc.zzaM(false);
            } catch (SQLiteConstraintException e) {
                String str7 = "Hit has already been sent: ";
                str5 = String.valueOf(str);
                zzayx.m9v(str5.length() != 0 ? str7.concat(str5) : new String(str7));
            } catch (SQLiteException e2) {
    ...
    public void dispatch() {
        zzayx.m9v("GTM Dispatch running...");
        if (this.zzbIb.zzPa()) {
            List zzmW = zzmW(40);
            if (zzmW.isEmpty()) {
                zzayx.m9v("...nothing to dispatch");
    ...
    public void zza(long j, String str, String str2, String str3, Map<String, String> map, String str4) {
        ...
        if (zzazc.zzQB().isPreview()) {
            zzayx.m9v("Sending hits immediately under preview.");
            dispatch();
        }
    }
    ...
    int zznS() {
        ...
        zzayx.m9v("Removed " + delete + " stale hits.");
        zzayt com_google_android_gms_internal_zzayt = this.zzbIc;
        if (zzPw() != 0) {
            z = false;
        }
