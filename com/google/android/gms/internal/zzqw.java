...
public class zzqw extends WebChromeClient {
    ...
    class C07191 implements OnCancelListener {
        final /* synthetic */ JsResult zzZH;

        C07191(JsResult jsResult) {
            this.zzZH = jsResult;
        }
    ...
    class C07224 implements OnCancelListener {
        final /* synthetic */ JsPromptResult zzZI;

        C07224(JsPromptResult jsPromptResult) {
    ...
    class C07235 implements OnClickListener {
        ...
        C07235(JsPromptResult jsPromptResult) {
            this.zzZI = jsPromptResult;
        }
    ...
    class C07246 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzZI;
        final /* synthetic */ EditText zzZJ;

        C07246(JsPromptResult jsPromptResult, EditText editText) {
            this.zzZI = jsPromptResult;
            this.zzZJ = editText;
        }
    ...
    private static void zza(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C07213(jsResult)).setNegativeButton(17039360, new C07202(jsResult)).setOnCancelListener(new C07191(jsResult)).create().show();
    }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C07246(jsPromptResult, editText)).setNegativeButton(17039360, new C07235(jsPromptResult)).setOnCancelListener(new C07224(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C07257.zzZK[consoleMessage.messageLevel().ordinal()]) {
            case 1:
                zzpy.m10e(valueOf);
                break;
            case 2:
