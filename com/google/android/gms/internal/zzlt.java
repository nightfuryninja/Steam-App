...
public class zzlt {
    ...
    class C06363 implements zzpn<zzix> {
        final /* synthetic */ zzlt zzQa;

        C06363(zzlt com_google_android_gms_internal_zzlt) {
    ...
    private void zziG() {
        synchronized (zztU) {
            if (!zzPT) {
                zzPU = new zzja(this.mContext.getApplicationContext() != null ? this.mContext.getApplicationContext() : this.mContext, this.zzPo.zzSF.zzvf, zza(this.zzPo, (String) zzfx.zzDR.get()), new C06363(this), new zzb());
                zzPT = true;
            }
        }
    }
