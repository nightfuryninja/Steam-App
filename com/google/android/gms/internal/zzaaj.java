...
public class zzaaj implements zzaam {
    ...
    class C02761 implements Runnable {
        ...
        C02761(zzaaj com_google_android_gms_internal_zzaaj) {
    ...
    private static class zza implements com.google.android.gms.common.internal.zzf.zzf {
        ...
        public void zzg(ConnectionResult connectionResult) {
            ...
            if (com_google_android_gms_internal_zzaaj != null) {
                ...
                zzac.zza(z, "onReportServiceBinding must be called on the GoogleApiClient handler thread");
    ...
    private void zzvE() {
        this.zzazK.zzvP();
        zzaao.zzvR().execute(new C02761(this));
        if (this.zzazS != null) {
            if (this.zzazX) {
