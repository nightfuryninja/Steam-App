...
public class zzbfo implements Runnable {
    ...
    boolean zzRq() {
        if (!zzbV("android.permission.INTERNET")) {
            zzayx.m8e("Missing android.permission.INTERNET. Please add the following declaration to your AndroidManifest.xml: <uses-permission android:name=\"android.permission.INTERNET\" />");
            return false;
            ...
            zzayx.m8e("Missing android.permission.ACCESS_NETWORK_STATE. Please add the following declaration to your AndroidManifest.xml: <uses-permission android:name=\"android.permission.ACCESS_NETWORK_STATE\" />");
            return false;
        }
    }
    ...
    void zzgq() {
        ...
        String valueOf;
        if (zzRq()) {
            zzayx.m9v("Starting to load resource from Network.");
