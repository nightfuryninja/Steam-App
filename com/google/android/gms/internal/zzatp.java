...
public class zzatp {
    ...
    class C03141 implements Runnable {
        ...
        C03141(zzatp com_google_android_gms_internal_zzatp) {
    ...
    class C03174 implements zza {
        final /* synthetic */ zzatp zzbtH;

        C03174(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
    ...
    class C03185 implements zza {
        final /* synthetic */ zzatp zzbtH;

        C03185(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
    ...
    zzatp(zzatt com_google_android_gms_internal_zzatt) {
        ...
        this.zzbtg.zzm(new C03141(this));
    }
        ...
        if (zzLn == null) {
            ...
            if (!zzn.isEmpty()) {
                ...
                try {
                    ...
                    zzLy().zza(zzKG, url, zza, null, new C03174(this));
    ...
    void zzb(zzasp com_google_android_gms_internal_zzasp) {
        ...
        try {
            ...
            zzLy().zza(com_google_android_gms_internal_zzasp.zzjI(), url, map, new C03185(this));
        } catch (MalformedURLException e) {
