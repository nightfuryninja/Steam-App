...
public class zzxu extends UIController {
    ...
    private final OnClickListener zzasw = new C07581(this);
    private final int zzatd;

    class C07581 implements OnClickListener {
        final /* synthetic */ zzxu zzatf;

        C07581(zzxu com_google_android_gms_internal_zzxu) {
            this.zzatf = com_google_android_gms_internal_zzxu;
        }
