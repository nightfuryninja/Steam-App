...
public class zzkl extends zzko {
    ...
    class C06242 implements OnClickListener {
        ...
        C06242(zzkl com_google_android_gms_internal_zzkl) {
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzv.zzcJ().zzaX(zzax)) {
                    ...
                    zzB.setTitle(resources != null ? resources.getString(C0154R.string.store_picture_title) : "Save image");
                    zzB.setMessage(resources != null ? resources.getString(C0154R.string.store_picture_message) : "Allow Ad to store image in Picture gallery?");
                    zzB.setPositiveButton(resources != null ? resources.getString(C0154R.string.accept) : "Accept", new OnClickListener(this) {
                        final /* synthetic */ zzkl zzLI;
                    ...
                    zzB.setNegativeButton(resources != null ? resources.getString(C0154R.string.decline) : "Decline", new C06242(this));
                    zzB.create().show();
                    return;
                }
