...
public class zzpl {
    ...
    class C07023 implements OnClickListener {
        C07023(zzpl com_google_android_gms_internal_zzpl) {
        }
    ...
    class C07034 implements Runnable {
        final /* synthetic */ zzpl zzXg;

        C07034(zzpl com_google_android_gms_internal_zzpl) {
    ...
    class C07045 implements Runnable {
        final /* synthetic */ zzpl zzXg;

        C07045(zzpl com_google_android_gms_internal_zzpl) {
            this.zzXg = com_google_android_gms_internal_zzpl;
        }
    ...
    private void zzku() {
        if (this.mContext instanceof Activity) {
            ...
            if (resources != null) {
                string = resources.getString(C0154R.string.debug_menu_title);
            } else {
                Object obj = "Select a Debug Mode";
            }
            String string2 = resources != null ? resources.getString(C0154R.string.debug_menu_ad_information) : "Ad Information";
            String string3 = resources != null ? resources.getString(C0154R.string.debug_menu_creative_preview) : "Creative Preview";
            String string4 = resources != null ? resources.getString(C0154R.string.debug_menu_troubleshooting) : "Troubleshooting";
    ...
    private void zzkv() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setNegativeButton("Close", new C07023(this));
            builder.create().show();
            return;
        }
        zzpy.zzbd("Can not create dialog without Activity Context");
    ...
    private void zzkw() {
        ...
        zzph.zza(new C07034(this));
    }

    private void zzkx() {
        zzpy.zzbc("Debug mode [Troubleshooting] selected.");
        zzph.zza(new C07045(this));
    }
