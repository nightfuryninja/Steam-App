...
public class zza {
    ...
    class C07761 implements zza {
        final /* synthetic */ zza zzbCI;

        C07761(zza com_google_android_gms_tagmanager_zza) {
    ...
    class C07772 implements Runnable {
        ...
        C07772(zza com_google_android_gms_tagmanager_zza) {
            this.zzbCI = com_google_android_gms_tagmanager_zza;
        }
    ...
    public zza(Context context, zza com_google_android_gms_tagmanager_zza_zza, zze com_google_android_gms_common_util_zze) {
        ...
        this.zzWx = new Thread(new C07772(this));
    }
