...
class zzcx {
    ...
    class C07834 implements zza {
        C07834(zzcx com_google_android_gms_tagmanager_zzcx) {
        }
        ...
        switch (com_google_android_gms_internal_zzaj_zza.type) {
            ...
            case 3:
                ...
                if (com_google_android_gms_internal_zzaj_zza.zzly.length != com_google_android_gms_internal_zzaj_zza.zzlz.length) {
                    ...
                    zzbo.m12e(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
                    return zzbFB;
                }
            ...
            case 4:
                if (set.contains(com_google_android_gms_internal_zzaj_zza.zzlA)) {
                    ...
                    zzbo.m12e(new StringBuilder((String.valueOf(valueOf).length() + 79) + String.valueOf(str).length()).append("Macro cycle detected.  Current macro reference: ").append(valueOf).append(".  Previous macro references: ").append(str).append(".").toString());
                    return zzbFB;
                }
            ...
            case 7:
                ...
                return new zzce(zzm, false);
            default:
                zzbo.m12e("Unknown type: " + com_google_android_gms_internal_zzaj_zza.type);
                return zzbFB;
        }
    }
    ...
    private zzce<com.google.android.gms.internal.zzaj.zza> zza(String str, Set<String> set, zzbr com_google_android_gms_tagmanager_zzbr) {
        ...
        if (com_google_android_gms_tagmanager_zzcx_zzc == null) {
            ...
            zzbo.m12e(new StringBuilder((String.valueOf(valueOf).length() + 15) + String.valueOf(str).length()).append(valueOf).append("Invalid macro: ").append(str).toString());
            this.zzbFM--;
            return zzbFB;
        }
    ...
    private zzce<com.google.android.gms.internal.zzaj.zza> zza(Map<String, zzam> map, com.google.android.gms.internal.zzbgi.zza com_google_android_gms_internal_zzbgi_zza, Set<String> set, zzcp com_google_android_gms_tagmanager_zzcp) {
        ...
        if (com_google_android_gms_internal_zzaj_zza == null) {
            zzbo.m12e("No function id in properties");
            return zzbFB;
        }
        ...
        if (com_google_android_gms_tagmanager_zzam == null) {
            zzbo.m12e(String.valueOf(str).concat(" has no backing implementation."));
            return zzbFB;
        }
        ...
        zzbo.m12e(new StringBuilder(((String.valueOf(str).length() + 43) + String.valueOf(valueOf).length()) + String.valueOf(valueOf2).length()).append("Incorrect keys for function ").append(str).append(" required ").append(valueOf).append(" had ").append(valueOf2).toString());
        return zzbFB;
    }
    ...
    zzce<Set<com.google.android.gms.internal.zzbgi.zza>> zza(Set<zze> set, zzcw com_google_android_gms_tagmanager_zzcw) {
        return zza((Set) set, new HashSet(), new C07834(this), com_google_android_gms_tagmanager_zzcw);
    }
