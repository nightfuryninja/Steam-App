...
class zzo implements ContainerHolder {
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                case 1:
                    ...
                    return;
                default:
                    zzbo.m12e("Don't know how to handle this message.");
                    return;
            }
        }
    }
    ...
    String getContainerId() {
        ...
        zzbo.m12e("getContainerId called on a released ContainerHolder.");
        return "";
    }
    ...
    public synchronized void refresh() {
        if (this.zzaKt) {
            zzbo.m12e("Refreshing a released ContainerHolder.");
        }
    }

    public synchronized void release() {
        if (this.zzaKt) {
            zzbo.m12e("Releasing a released ContainerHolder.");
        } else {
            this.zzaKt = true;
            this.zzbDe.zzb(this);
            this.zzbDa.release();
    ...
    String zzOC() {
        ...
        zzbo.m12e("setCtfeUrlPathAndQuery called on a released ContainerHolder.");
        return "";
    }
