...
public class IPersistentConnectionImpl extends zza {
    ...
    class C07932 implements zzblu {
        final /* synthetic */ zzm zzcba;

        C07932(zzm com_google_firebase_database_connection_idl_zzm) {
    ...
    class C07943 extends zzl.zza {
        final /* synthetic */ zzblr.zza zzcbb;

        C07943(zzblr.zza com_google_android_gms_internal_zzblr_zza) {
    ...
    class C07954 implements zzblr.zza {
        final /* synthetic */ zzl zzcbc;

        C07954(zzl com_google_firebase_database_connection_idl_zzl) {
    ...
    class C07975 extends zzh.zza {
        final /* synthetic */ zzblm zzcbd;

        C07975(zzblm com_google_android_gms_internal_zzblm) {
    ...
    class C07996 implements zzblm {
        final /* synthetic */ zzh zzcbf;

        C07996(zzh com_google_firebase_database_connection_idl_zzh) {
    ...
    private static zzblm zza(zzh com_google_firebase_database_connection_idl_zzh) {
        return new C07996(com_google_firebase_database_connection_idl_zzh);
    }

    private static zzblr.zza zza(zzl com_google_firebase_database_connection_idl_zzl) {
        return new C07954(com_google_firebase_database_connection_idl_zzl);
    }

    private static zzblu zza(zzm com_google_firebase_database_connection_idl_zzm) {
        return new C07932(com_google_firebase_database_connection_idl_zzm);
    }

    private static zzh zza(zzblm com_google_android_gms_internal_zzblm) {
        return new C07975(com_google_android_gms_internal_zzblm);
    }

    private static zzl zza(zzblr.zza com_google_android_gms_internal_zzblr_zza) {
        return new C07943(com_google_android_gms_internal_zzblr_zza);
    }
