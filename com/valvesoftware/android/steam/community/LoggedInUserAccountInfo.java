...
public class LoggedInUserAccountInfo {
    ...
    public static void resetAllCookies() {
        ...
        s_strLanguage = SteamCommunityApplication.GetInstance().getString(C0815R.string.DO_NOT_LOCALIZE_COOKIE_Steam_Language);
    ...
    public static void updateLanguage() {
        String strSelectedLanguage = SteamCommunityApplication.GetInstance().getString(C0815R.string.DO_NOT_LOCALIZE_COOKIE_Steam_Language);
