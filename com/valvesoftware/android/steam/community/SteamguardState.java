...
public class SteamguardState {
    ...
    static class C08211 implements Comparator<SteamguardState> {
        C08211() {
        }
    ...
    class C08222 extends ResponseListener {
        C08222() {
        }
    ...
    class C08255 extends ResponseListener {
        C08255() {
        }
    ...
    public static ArrayList<SteamguardState> getSortedTwoFactorSteamGuardStates() {
        ...
        Collections.sort(sgStates, new C08211());
        return sgStates;
    }
    ...
    public void startGetTwoFactorStatus() {
        ...
        requestBuilder.setResponseListener(new C08222());
            ...
            public void onSuccess(JSONObject json) {
                if (!json.optBoolean("success")) {
                    ...
                    if (json.optInt("status") == 89) {
                        completion.failure(json.optInt("status"), SteamguardState.sContext.getResources().getString(C0815R.string.SteamMobile_Steamguard_BadCode));
                        return;
                    }
    ...
    private void sendEmailOfType(ETwoFactorEmailType emailType, String... arguments) {
        ...
        requestBuilder.setResponseListener(new C08255());
        sendRequest(requestBuilder);
    }
