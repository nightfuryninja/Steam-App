...
public class SettingInfoDB extends BroadcastReceiver {
    ...
    class C08161 implements UpdateListener {
        C08161() {
        }
    ...
    class C08172 implements UpdateListener {
        C08172() {
        }
    ...
    SettingInfoDB() {
        ...
        setting.m_resid = C0815R.string.settings_chat_links_nonsteam;
        setting.m_resid_detailed = C0815R.string.settings_chat_links_nonsteam_details;
        ...
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.settings_personal_dob;
        setting.m_resid_detailed = C0815R.string.settings_personal_dob_instr;
        setting.m_key = "personal_dob";
        setting.m_defaultValue = "";
        setting.m_type = SettingType.DATE;
        setting.m_access = AccessRight.VALID_ACCOUNT;
        setting.m_pUpdateListener = new C08161();
        this.m_settingDOB = setting;
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.settings_notifications_ring;
        ...
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.settings_notifications_sound;
        radios = new RadioSelectorItem[3];
        radios[0] = new RadioSelectorItem();
        radios[0].value = -1;
        radios[0].resid_text = C0815R.string.settings_notifications_sound_all;
        radios[1] = new RadioSelectorItem();
        radios[1].value = 0;
        radios[1].resid_text = C0815R.string.settings_notifications_sound_first;
        radios[2] = new RadioSelectorItem();
        radios[2].value = 1;
        radios[2].resid_text = C0815R.string.settings_notifications_sound_never;
        setting.m_extraData = radios;
        ...
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.settings_notifications_vibrate;
        radios = new RadioSelectorItem[3];
        radios[0] = new RadioSelectorItem();
        radios[0].value = -1;
        radios[0].resid_text = C0815R.string.settings_notifications_vibrate_all;
        radios[1] = new RadioSelectorItem();
        radios[1].value = 0;
        radios[1].resid_text = C0815R.string.settings_notifications_vibrate_first;
        radios[2] = new RadioSelectorItem();
        radios[2].value = 1;
        radios[2].resid_text = C0815R.string.settings_notifications_vibrate_never;
        setting.m_extraData = radios;
        ...
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.settings_notifications_im2;
        radios = new RadioSelectorItem[2];
        radios[0] = new RadioSelectorItem();
        radios[0].value = 1;
        radios[0].resid_text = C0815R.string.settings_notifications_im_detailed;
        radios[1] = new RadioSelectorItem();
        radios[1].value = 0;
        radios[1].resid_text = C0815R.string.settings_notifications_im_off;
        setting.m_extraData = radios;
        setting.m_key = "notifications_im2";
        setting.m_defaultValue = "1";
        setting.m_type = SettingType.RADIOSELECTOR;
        setting.m_access = AccessRight.VALID_ACCOUNT;
        setting.m_pUpdateListener = new C08172();
        this.m_usePushInBackground = setting;
        this.m_settingsList.add(this.m_usePushInBackground);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.settings_personal_steam_preferences;
        setting.m_resid_detailed = C0815R.string.settings_personal_steam_preferences_detailed;
        setting.m_defaultValue = URL_SETTINGS_ONLINE;
        setting.m_type = SettingType.URI;
        setting.m_access = AccessRight.VALID_ACCOUNT;
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.webview_ssl_untrusted_prompt;
        radios = new RadioSelectorItem[3];
        radios[0] = new RadioSelectorItem();
        radios[0].value = 1;
        radios[0].resid_text = C0815R.string.webview_ssl_untrusted_prompt_cancel;
        radios[1] = new RadioSelectorItem();
        radios[1].value = 0;
        radios[1].resid_text = C0815R.string.webview_ssl_untrusted_prompt_ok_once;
        radios[2] = new RadioSelectorItem();
        radios[2].value = -1;
        radios[2].resid_text = C0815R.string.webview_ssl_untrusted_prompt_ok_always;
        setting.m_extraData = radios;
        ...
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.Settings_About;
        setting.m_access = AccessRight.USER;
        this.m_settingsList.add(setting);
        setting = new SettingInfo();
        setting.m_resid = C0815R.string.Settings_Version;
