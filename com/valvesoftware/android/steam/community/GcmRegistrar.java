...
public class GcmRegistrar {
    ...
    class C08071 extends AsyncTask {
        ...
        protected String doInBackground(Object... params) {
            ...
            try {
                ...
                if (n < 6) {
                    GcmRegistrar.gcmHandler.postDelayed(new C08061(), (long) ((1 << n) * 1000));
                    return msg;
                }
    ...
    public void registerWithGcm() {
        if (LoggedInUserAccountInfo.getLoginSteamID() != null && checkPlayServices()) {
            new C08071().execute(new Object[]{null, null, null});
        }
    }
            ...
            new AsyncTask() {
                ...
                protected Object doInBackground(Object[] params) {
                    ...
                    try {
                        ...
                        GcmRegistrar.gcmHandler.postDelayed(new C08081(), 2000);
                        return msg;
                    }
                }
