...
public class PaypalUriActivity extends FragmentActivity {
    ...
    protected int m_residActivityLayout = C0815R.layout.webview_activity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((WebViewFragment) getSupportFragmentManager().findFragmentById(C0815R.id.webview)).loadUrl(this.m_url);
        this.m_BrowserLocationBar = (TextView) findViewById(C0815R.id.webview_browser_location);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent result) {
        if (result != null) {
            ...
            if (sCall == null || sCall.length() <= 0) {
                ...
                ((WebViewFragment) getSupportFragmentManager().findFragmentById(C0815R.id.webview)).loadUrl(sUrl);
                return;
            }
            ((WebViewFragment) getSupportFragmentManager().findFragmentById(C0815R.id.webview)).loadUrl("javascript:(function(){" + sCall + ";})()");
        }
    }
}
