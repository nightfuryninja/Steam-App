...
public abstract class BaseActivity extends ActionBarActivity {
    protected int activityLayoutId = C0815R.layout.main_activity;
    ...
    class C08501 implements NotificationCountUpdateListener {
        C08501() {
        }
    ...
    class C08545 extends OnQueryTextListenerCompat {
        C08545() {
        }
    ...
    class C08556 extends OnCloseListenerCompat {
        C08556() {
        }
    ...
    class C08578 implements OnMenuItemClickListener {
        C08578() {
        }
    ...
    class C08589 implements OnMenuItemClickListener {
        C08589() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isTaskRoot()) {
            UmqCommunicator.getInstance().setNotificationCountUpdateListener(new C08501());
    ...
    protected void setupView() {
        this.drawerLayout = (DrawerLayout) findViewById(C0815R.id.drawer_layout);
        this.expandableListView = (ExpandableListView) findViewById(C0815R.id.navigation);
        Toolbar toolbar = (Toolbar) findViewById(C0815R.id.steam_toolbar);
        this.menuBar = (MenuBar) findViewById(C0815R.id.menu_bar);
        this.progressView = ((LayoutInflater) getSystemService("layout_inflater")).inflate(C0815R.layout.progress_layout, null);
        ((ProgressBar) this.progressView.findViewById(C0815R.id.progressBar)).getIndeterminateDrawable().setColorFilter(C0815R.color.holo_gray_light, Mode.DST);
        if (useLimitedMenuBar()) {
            toolbar.setVisibility(8);
            this.menuBar.setVisibility(0);
            this.menuBar.setHamburgerClickedListener(new C08512());
        } else {
            try {
                setSupportActionBar(toolbar);
                getSupportActionBar().setDisplayShowHomeEnabled(true);
                getSupportActionBar();
                ActionBarDrawerToggle mDrawerToggle = new ActionBarDrawerToggle(this, this.drawerLayout, toolbar, C0815R.string.app_name, C0815R.string.app_name) {
        ...
        setupNavDrawer();
        View v = findViewById(C0815R.id.nav_header_view);
        if (v != null) {
            v.setOnClickListener(new C08534());
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (useLimitedMenuBar()) {
            ...
            if (this.searchTextWatcher != null) {
                ...
                searchViewMenuItem.setIcon(C0815R.drawable.ic_action_search);
                ...
                if (searchView != null) {
                    ...
                    if (v != null && (v instanceof ImageView)) {
                        ((ImageView) v).setImageResource(C0815R.drawable.ic_action_search);
                    }
                    SearchViewCompat.setOnQueryTextListener(searchView, new C08545());
                    SearchViewCompat.setOnCloseListener(searchView, new C08556());
            ...
            if (this.refreshClickListener != null) {
                ...
                this.refreshItem.setIcon(C0815R.drawable.ic_action_refresh);
                MenuItemCompat.setShowAsAction(this.refreshItem, 2);
                this.refreshItem.setOnMenuItemClickListener(new C08578());
            }
            if (this.extraMenuItem != null) {
                MenuItem item = menu.add("");
                item.setIcon(this.extraMenuItem.iconResourceId);
                MenuItemCompat.setShowAsAction(item, 2);
                item.setOnMenuItemClickListener(new C08589());
            }
        }
        return true;
    }
    ...
    protected SearchBarFragment getSearchBar() {
        Fragment f = getSupportFragmentManager().findFragmentById(C0815R.id.searchbar);
    ...
    private View getNavigationDrawerHeader() {
        View headerView = View.inflate(this, C0815R.layout.nav_header, null);
        ImageView avatarView = (ImageView) headerView.findViewById(C0815R.id.avatar);
        TextView nameView = (TextView) headerView.findViewById(C0815R.id.name);
    ...
    private List<NavDrawerItem> getNavigationItems() {
        ...
        navDrawerItems.add(new NavDrawerItem(-1, C0815R.drawable.ic_action_steamguard, C0815R.string.Steam_Guard, SteamAppIntents.viewSteamGuard(context), this.drawerLayout));
        navDrawerItems.add(new NavDrawerItem(-1, C0815R.drawable.ic_action_steamguard, C0815R.string.Confirmations, SteamAppIntents.viewConfirmations(context), this.drawerLayout));
        navDrawerItems.add(new NavDrawerItem(C0815R.string.menu_chat, 0, C0815R.string.menu_chat, SteamAppIntents.viewFriendsList(context), this.drawerLayout));
        navDrawerItems.add(getNotificationNavigationItems(this.drawerLayout));
        NavDrawerItem storeGroup = new NavDrawerItem(C0815R.string.Store_Caps, 0, C0815R.string.Store, null, this.drawerLayout);
        storeGroup.add(new NavDrawerItem(C0815R.string.Store_Caps, 0, C0815R.string.Catalog, SteamAppIntents.viewCatalog(context), this.drawerLayout));
        storeGroup.add(new NavDrawerItem(C0815R.string.Store_Caps, 0, C0815R.string.Cart, SteamAppIntents.viewShoppingCart(context), this.drawerLayout));
        storeGroup.add(new NavDrawerItem(C0815R.string.Store_Caps, 0, C0815R.string.Search, SteamAppIntents.searchSteam(context), this.drawerLayout));
        storeGroup.add(new NavDrawerItem(C0815R.string.Store_Caps, 0, C0815R.string.Wishlist, SteamAppIntents.viewWishList(context), this.drawerLayout));
        storeGroup.add(new NavDrawerItem(C0815R.string.Store_Caps, 0, C0815R.string.Steam_News, SteamAppIntents.viewSteamNews(context), this.drawerLayout));
        storeGroup.add(new NavDrawerItem(C0815R.string.Settings_Caps, 0, C0815R.string.Account_Details, SteamAppIntents.viewAccountDetails(context), this.drawerLayout));
        navDrawerItems.add(storeGroup);
        NavDrawerItem communityGroup = new NavDrawerItem(C0815R.string.Community_Caps, 0, C0815R.string.menu_community, null, this.drawerLayout);
        communityGroup.add(new NavDrawerItem(C0815R.string.Community_Caps, 0, C0815R.string.menu_community_home, SteamAppIntents.communityURLIntent(context, "/"), this.drawerLayout));
        communityGroup.add(new NavDrawerItem(C0815R.string.Community_Caps, 0, C0815R.string.menu_community_discussions, SteamAppIntents.communityURLIntent(context, "/discussions/"), this.drawerLayout));
        communityGroup.add(new NavDrawerItem(C0815R.string.Community_Caps, 0, C0815R.string.menu_community_market, SteamAppIntents.communityURLIntent(context, "/market/"), this.drawerLayout));
        communityGroup.add(new NavDrawerItem(C0815R.string.Community_Caps, 0, C0815R.string.menu_community_broadcasts, SteamAppIntents.communityURLIntent(context, "/?subsection=broadcasts"), this.drawerLayout));
        navDrawerItems.add(communityGroup);
        NavDrawerItem personalGroup = new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal, null, this.drawerLayout);
        personalGroup.add(new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal_activity, SteamAppIntents.profileURLIntent(context, "/home/"), this.drawerLayout));
        personalGroup.add(new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal_profile, SteamAppIntents.profileURLIntent(context, "/"), this.drawerLayout));
        personalGroup.add(new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal_friends, SteamAppIntents.profileURLIntent(context, "/friends/"), this.drawerLayout));
        personalGroup.add(new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal_groups, SteamAppIntents.profileURLIntent(context, "/groups/"), this.drawerLayout));
        personalGroup.add(new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal_content, SteamAppIntents.profileURLIntent(context, "/screenshots/"), this.drawerLayout));
        personalGroup.add(new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal_badges, SteamAppIntents.profileURLIntent(context, "/badges/"), this.drawerLayout));
        personalGroup.add(new NavDrawerItem(C0815R.string.menu_personal, 0, C0815R.string.menu_personal_inventory, SteamAppIntents.profileURLIntent(context, "/inventory/"), this.drawerLayout));
        navDrawerItems.add(personalGroup);
        navDrawerItems.add(new NavDrawerItem(C0815R.string.Library, 0, C0815R.string.Library, SteamAppIntents.viewLibrary(context), this.drawerLayout));
        navDrawerItems.add(new NavDrawerItem(C0815R.string.menu_support, 0, C0815R.string.menu_support, SteamAppIntents.helpURLIntent(context, "/"), this.drawerLayout));
        NavDrawerItem settingsGroup = new NavDrawerItem(C0815R.string.Settings_Caps, 0, C0815R.string.Settings, null, this.drawerLayout);
        settingsGroup.add(new NavDrawerItem(C0815R.string.Settings_Caps, 0, C0815R.string.ApplicationPreferences, SteamAppIntents.viewSettings(context), this.drawerLayout));
        if (LoggedInUserAccountInfo.dontLoginToChat()) {
            i = C0815R.string.chat_go_online;
        } else {
            i = C0815R.string.chat_go_offline;
        }
        settingsGroup.add(new NavDrawerItem(C0815R.string.Settings_Caps, 0, i, null, this.drawerLayout) {

            class C08471 extends ResponseListener {
                C08471() {
                }
            ...
            public void onClick() {
                ResponseListener listener = new C08471();
            ...
            public int getNameId() {
                return LoggedInUserAccountInfo.dontLoginToChat() ? C0815R.string.chat_go_online : C0815R.string.chat_go_offline;
            }
        });
        settingsGroup.add(new NavDrawerItem(C0815R.string.Settings_Caps, 0, C0815R.string.Sign_Out, null, this.drawerLayout) {
            ...
            class C08491 implements DialogInterface.OnClickListener {
                ...
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    BaseActivity.this.signOutHandler.postDelayed(new C08481(), 500);
                }
            }

            public void onClick() {
                new Builder(BaseActivity.this).setTitle(C0815R.string.Sign_Out).setIcon(17301543).setPositiveButton(17039379, new C08491()).setNegativeButton(17039369, null).show();
            }
        });
    ...
    protected NavDrawerItem getNotificationNavigationItems(DrawerLayout drawerLayout) {
        Context context = SteamCommunityApplication.GetInstance();
        NavDrawerNotificationItem navDrawerGroupItem = new NavDrawerGroupItem(C0815R.string.Notifications, C0815R.string.Notifications, drawerLayout);
        registerNotificationDrawerItem(EUserNotification.k_EUserNotificationInvalid, navDrawerGroupItem);
        NavDrawerNotificationItem commentNotifications = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_comments, SteamAppIntents.notificationCommentsIntent(context), drawerLayout, false);
        ...
        NavDrawerNotificationItem items = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_items, SteamAppIntents.notificationItemsIntent(context), drawerLayout, false);
        registerNotificationDrawerItem(EUserNotification.k_EUserNotificationItem, items);
        navDrawerGroupItem.add(items);
        NavDrawerNotificationItem invites = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_invites, SteamAppIntents.notificationInvitesIntent(context), drawerLayout, false);
        registerNotificationDrawerItem(EUserNotification.k_EUserNotificationFriendInvite, invites);
        navDrawerGroupItem.add(invites);
        NavDrawerNotificationItem gifts = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_gifts, SteamAppIntents.notificationGiftsIntent(context), drawerLayout, false);
        registerNotificationDrawerItem(EUserNotification.k_EUserNotificationGift, gifts);
        navDrawerGroupItem.add(gifts);
        NavDrawerNotificationItem tradeOffers = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_trade, SteamAppIntents.notificationTradeOffersIntent(context), drawerLayout, true);
        ...
        NavDrawerNotificationItem offlineMessages = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_chat, SteamAppIntents.viewFriendsList(context), drawerLayout, true);
        ...
        NavDrawerNotificationItem asyncgame = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_asyncgameinvite, SteamAppIntents.notificationAsyncGameIntent(context), drawerLayout, true);
        ...
        NavDrawerNotificationItem moderatormessages = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_moderatormessages, SteamAppIntents.notificationModeratorMessageIntent(context), drawerLayout, true);
        ...
        NavDrawerNotificationItem helprequestreply = new NavDrawerNotificationItem(C0815R.string.Notifications, C0815R.string.notification_helprequestreply, SteamAppIntents.notificationHelpRequestReplyIntent(context), drawerLayout, true);
