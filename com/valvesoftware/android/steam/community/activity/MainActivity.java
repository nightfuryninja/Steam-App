...
public class MainActivity extends BaseActivity {
    ...
    class C08602 extends ResponseListener {
        C08602() {
        }
    ...
    private void refreshUserNotificationCounts() {
        ...
        notificationCountRequest.setResponseListener(new C08602());
    ...
    private void loadFragment(Fragment fragment, String newEntryName, boolean bForce) {
        ...
        fragmentTransaction.replace(C0815R.id.fragment_placeholder, fragment);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == 4) {
            Fragment fragment = getSupportFragmentManager().findFragmentById(C0815R.id.fragment_placeholder);
