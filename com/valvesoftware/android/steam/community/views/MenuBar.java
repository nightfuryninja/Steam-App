...
public class MenuBar extends LinearLayout {
    ...
    public MenuBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0815R.layout.menu_bar, this, true);
        this.hamburgerButton = (Button) findViewById(C0815R.id.hamburgerButton);
        this.titleTextView = (TextView) findViewById(C0815R.id.titleLabel);
        this.searchButton = (Button) findViewById(C0815R.id.titleNavSearchButton);
        this.refreshButton = (Button) findViewById(C0815R.id.titleNavRefreshButton);
        this.progressBar = (ProgressBar) findViewById(C0815R.id.titleProgressBar);
        this.extraMenuButton = (ImageButton) findViewById(C0815R.id.titleExtraButton);
    }
