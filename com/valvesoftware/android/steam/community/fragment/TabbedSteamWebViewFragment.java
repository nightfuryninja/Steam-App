...
public class TabbedSteamWebViewFragment extends WebViewFragment {
    private static final int[] m_categoryButtons = new int[]{C0815R.id.web_select_1, C0815R.id.web_select_2, C0815R.id.web_select_3, C0815R.id.web_select_4, C0815R.id.web_select_5, C0815R.id.web_select_6, C0815R.id.web_select_7, C0815R.id.web_select_8};
    private LinearLayout btnLayout;
    private int m_selectedTab = 0;
    private final OnCheckedChangeListener m_toggleListener = new C09271();
    ...
    class C09282 extends ResponseListener {
        C09282() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((RadioGroup) view.findViewById(C0815R.id.toggleGroup)).setOnCheckedChangeListener(this.m_toggleListener);
        this.btnLayout = (LinearLayout) view.findViewById(C0815R.id.web_select_layout);
        return view;
    }

    private void setCategoriesFailed() {
        this.m_webView.setViewContentsShowFailure(SteamAppUri.catalog().toString(), SteamCommunityApplication.GetInstance().getString(C0815R.string.Web_Error_Reload));
    }
    ...
    private void getCategoryUrlInfo(String url) {
        ...
        requestBuilder.setResponseListener(new C09282());
