...
public class SettingsFragment extends ListFragment {
    ...
    class C09131 implements OnClickListener {
        C09131() {
        }
    ...
    public static class RadioSelectorItemOnClickListener implements OnClickListener {
        Activity activity;
        AlertDialog alert;
        DialogInterface.OnClickListener m_onRadioButtonSelected = new C09171();
        SettingInfo settingInfo;
        TextView valueView;

        class C09171 implements DialogInterface.OnClickListener {
            C09171() {
            }
    ...
    private class SettingsListAdapter extends ArrayAdapter<SettingInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                v = ((LayoutInflater) SettingsFragment.this.m_owner.getSystemService("layout_inflater")).inflate(C0815R.layout.settings_list_item_info, null);
                v.setClickable(true);
            }
            v.setOnClickListener(null);
            TextView titleView = (TextView) v.findViewById(C0815R.id.label);
            titleView.setText(settingInfo.m_resid);
            final TextView valueView = (TextView) v.findViewById(C0815R.id.info);
            valueView.setText("");
            if (settingInfo.m_resid_detailed != 0) {
                valueView.setText(settingInfo.m_resid_detailed);
            }
            final ImageView chevronView = (ImageView) v.findViewById(C0815R.id.imageChevron);
            chevronView.setVisibility(8);
            final CheckBox checkBox = (CheckBox) v.findViewById(C0815R.id.setting_checkbox);
            ...
            switch (settingInfo.m_type) {
                ...
                case DATE:
                    ...
                    if (sValue == null || sValue.equals("")) {
                        valueView.setText(C0815R.string.date_not_set);
                    } else {
                        valueView.setText(DateConverter.formatDate(sValue));
                    }
                    v.setOnClickListener(new OnClickListener() {

                        class C09221 implements OnDateSetListener {
                            C09221() {
                            }
                        ...
                        public void onClick(View btn) {
                            ...
                            new CustomDatePickerDialog(context, new C09221(), myDOB, C0815R.string.settings_personal_dob_instr).show();
                        }
                    });
                    break;
                case URI:
                    ...
                    v.setOnClickListener(new OnClickListener() {
                        public void onClick(View btn) {
                            try {
                                ...
                                valueView.setText(settingInfo.m_defaultValue + " / " + SettingsFragment.this.getActivity().getString(C0815R.string.Market_Unavailable));
                                try {
                ...
                case RINGTONESELECTOR:
                    ...
                    try {
                        ...
                        valueView.setText(C0815R.string.settings_notifications_ring_steam);
                        v.setOnClickListener(/* anonymous class already generated */);
                    } catch (Exception e) {
                        valueView.setText(C0815R.string.settings_notifications_ring_default);
                    }
                    break;
                case UNREADMSG:
                    chevronView.setVisibility(0);
                    ...
                    v.setOnClickListener(new C09192());
                    break;
            }
            return v;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(C0815R.layout.settings_fragment, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (this.m_SettingsAdapter == null) {
            this.m_SettingsAdapter = new SettingsListAdapter(this.m_owner, C0815R.layout.settings_list_item_info, this.m_settingsInfoArray);
        }
        ...
        if (this.m_owner != null && ActivityHelper.fragmentIsActive(this)) {
            this.m_owner.setTitle(C0815R.string.Settings);
        }
    }
    ...
    private void setupUserAccountView(View v) {
        v = getView();
        if (v != null) {
            final TextView nameView = (TextView) v.findViewById(C0815R.id.name);
            final ImageView avatarView = (ImageView) v.findViewById(C0815R.id.avatar);
            ImageView avatarViewFrame = (ImageView) v.findViewById(C0815R.id.avatar_frame);
            View avatarNameContainer = v.findViewById(C0815R.id.avatar_name_container);
            avatarView.setImageResource(C0815R.drawable.placeholder_contact);
            avatarNameContainer.setOnClickListener(new C09131());
            ...
            avatarViewFrame.setImageResource(null != null ? C0815R.drawable.avatar_frame_online : C0815R.drawable.avatar_frame_offline);
            nameView.setTextColor(getActivity().getResources().getColor(null != null ? C0815R.color.online : C0815R.color.offline));
        }
    }
