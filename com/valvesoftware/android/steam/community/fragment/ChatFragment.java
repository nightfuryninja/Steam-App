...
public class ChatFragment extends Fragment {
    ...
    private OnClickListener clearChatHistoryListener = new C08651();
    ...
    class C08651 implements OnClickListener {
        ...
        public void onClick(View v) {
            new Builder(ChatFragment.this.getActivity()).setTitle(C0815R.string.Chat_clear_history).setIcon(17301543).setPositiveButton(17039379, new C08641()).setNegativeButton(17039369, null).show();
        }
    }

    class C08672 implements ChatStateListener {
        ...
        public void isTypingMessageReceived(List<UmqMessage> isTypingNotifications) {
            ...
            if (chatPartnerIsTyping && ChatFragment.this.chatViewAdapter != null) {
                ...
                new Handler().postDelayed(new C08661(), 4000);
            }
        }
    ...
    class C08683 implements LoggedInStatusChangedListener {
        C08683() {
        }
    ...
    class C08694 implements OnClickListener {
        C08694() {
        }
    ...
    class C08705 implements TextWatcher {
        C08705() {
        }
    ...
    class C08716 implements Runnable {
        C08716() {
        }
    ...
    class C08748 implements Runnable {
        C08748() {
        }
    ...
    class C08759 extends ResponseListener {
        C08759() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View fragmentView = inflater.inflate(C0815R.layout.chat_fragment, container, false);
    ...
    public void onResume() {
        ...
        if (ActivityHelper.fragmentIsActive(this)) {
            ...
            this.umqCommunicator.setChatStateListener(new C08672());
            this.umqCommunicator.updateChatMessages(this.chatPartnerSteamId);
            this.umqCommunicator.setChatLoggedInStatusChangedListener(new C08683());
            this.chatIsOfflineNotice.setVisibility(this.umqCommunicator.isLoggedInToChat() ? 8 : 0);
            if (!this.passwordWarningShown) {
                this.toast = Toast.makeText(getActivity(), C0815R.string.Chat_Headline_Message, 1);
    ...
    private void setupControls(View view) {
        this.chatIsOfflineNotice = view.findViewById(C0815R.id.chat_is_offline_notice);
        this.chatViewContents = (ListView) view.findViewById(C0815R.id.chat_view_contents);
        this.chatViewContents.setTranscriptMode(2);
        this.chatViewContents.setStackFromBottom(true);
        this.chatViewMessageTextBox = (EditText) view.findViewById(C0815R.id.chat_view_say_text);
        ((Button) view.findViewById(C0815R.id.chat_view_say_button)).setOnClickListener(new C08694());
        this.chatViewMessageTextBox.addTextChangedListener(new C08705());
        this.chatViewMessageTextBox.post(new C08716());
    }
    ...
    private void markMessagesRead() {
        SteamCommunityApplication.GetInstance().runOnBackgroundThread(new C08748());
        RequestBuilder requestBuilder = Endpoints.getMarkMessagesReadRequestBuilder(this.chatPartnerSteamId);
        requestBuilder.setResponseListener(new C08759());
    ...
    private void setupDeleteButton() {
        ...
        extraMenuItem.iconResourceId = C0815R.drawable.ic_action_delete;
