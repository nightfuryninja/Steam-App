...
public class FriendsListFragment extends ListFragment {
    ...
    class C08861 implements ChatStateListener {
        C08861() {
        }
    ...
    class C08872 implements LoggedInStatusChangedListener {
        C08872() {
        }
    ...
    class C08894 implements OnClickListener {
        C08894() {
        }
    ...
    class C08905 implements TextWatcher {
        C08905() {
        }
    ...
    class C08916 extends ResponseListener {
        C08916() {
        }
    ...
    class C08927 implements RepositoryCallback<List<Persona>> {
        C08927() {
        }
    ...
    class C08938 implements Runnable {
        C08938() {
        }
    ...
    class C08959 implements Runnable {
        C08959() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(C0815R.layout.friends_groups_list_fragment, container, false);
        this.chatIsOfflineNotice = v.findViewById(C0815R.id.chat_is_offline_notice);
        return v;
    }
    ...
    public void onResume() {
        ...
        this.umqCommunicator.setChatStateListener(new C08861());
        this.umqCommunicator.setChatLoggedInStatusChangedListener(new C08872());
        showProgressDialog();
    ...
    private void notifyItemContentsChanged() {
        this.uiThreadHandler.post(new C08883());
    }
    ...
    private void setTitleText() {
        if (this.mainActivity != null && ActivityHelper.fragmentIsActive(this)) {
            this.mainActivity.setTitle(C0815R.string.Friends);
        }
    }
    ...
    private void setupEventListeners() {
        if (this.mainActivity != null) {
            this.mainActivity.setRefreshButtonClickListener(new C08894());
            this.mainActivity.setSearchTextListener(new C08905());
        }
    }
    ...
    private void getFriendsList() {
        ...
        requestBuilder.setResponseListener(new C08916());
        sendRequest(requestBuilder);
    }

    private void getDetailedFriendInfo(Collection<String> steamIds) {
        showProgressDialog();
        PersonaRepository.getDetailedPersonaInfo((Collection) steamIds, new C08927());
    }
    ...
    private void cacheFriends() {
        ...
        SteamCommunityApplication.GetInstance().runOnBackgroundThread(new C08938());
    }
    ...
    private void updateFriendsWithLastMessageTimes() {
        SteamCommunityApplication.GetInstance().runOnBackgroundThread(new C08959());
    }
