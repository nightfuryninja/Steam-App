...
public class GroupListFragment extends ListFragment {
    ...
    class C08972 implements TextWatcher {
        C08972() {
        }
    ...
    class C08983 extends ResponseListener {
        C08983() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(C0815R.layout.friends_groups_list_fragment, container, false);
    }
    ...
    private void setTitleText() {
        ...
        if (mainActivity != null && ActivityHelper.fragmentIsActive(this)) {
            mainActivity.setTitle(C0815R.string.Groups);
        }
    }
    ...
    private void setupEventListeners() {
        ...
        if (parentActivity instanceof MainActivity) {
            ...
            mainActivity.setRefreshButtonClickListener(new C08961());
            mainActivity.setSearchTextListener(new C08972());
        }
    }
    ...
    private void getGroupsList() {
        ...
        requestBuilder.setResponseListener(new C08983());
