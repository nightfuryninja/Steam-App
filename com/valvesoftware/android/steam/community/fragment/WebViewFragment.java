...
public class WebViewFragment extends Fragment implements IBackButtonSupport {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout view = (LinearLayout) inflater.inflate(C0815R.layout.webview_fragment, container, false);
        this.m_webView = (SteamWebView) view.findViewById(C0815R.id.webView);
    ...
    public void onResume() {
        ...
        if (getActivity() instanceof MainActivity) {
            ((MainActivity) getActivity()).setRefreshButtonClickListener(new C09331());
        }
    }
