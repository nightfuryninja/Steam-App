...
public class TwoFactorCodeView extends LinearLayout implements CloseableView {
    ...
    private Runnable updateRunnable = new C09311();
    ...
    public TwoFactorCodeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0815R.layout.twofactor_code_fragment, this, true);
        setLayoutParams(new LayoutParams(getScreenWidth(), -1));
        this.mNormalColor = getResources().getColor(C0815R.color.twofactorcode_normal);
        this.mDangerColor = getResources().getColor(C0815R.color.twofactorcode_alert);
        this.mCode = (TextView) findViewById(C0815R.id.twofactorcode_code);
        this.mAccountName = (TextView) findViewById(C0815R.id.twofactorcode_account_name);
        this.mThermometer = (TwoFactorCodeThermometerView) findViewById(C0815R.id.twofactorcode_thermometer);
        this.mValveTime = (TextView) findViewById(C0815R.id.twofactorcode_valvetime);
    }
    ...
    public void update() {
        ...
        if (token != null) {
            ...
            enableArrow(C0815R.id.twofactor_back, this.bEnableBackArrow);
            enableArrow(C0815R.id.twofactor_forward, this.bEnableForwardArrow);
