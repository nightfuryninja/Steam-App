...
public abstract class BaseSearchListFragment extends ListFragment {
    ...
    class C08632 implements OnClickListener {
        C08632() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C0815R.layout.search_results_fragment, container, false);
        this.progressLabel = (TextView) view.findViewById(C0815R.id.search_progress_label);
        this.footerButtons = view.findViewById(C0815R.id.search_footer_buttons);
        this.footerButtons.setVisibility(8);
        this.footerBtnPrev = (TextView) view.findViewById(C0815R.id.search_footer_button_prev);
        this.footerBtnNext = (TextView) view.findViewById(C0815R.id.search_footer_button_next);
        this.footerBtnNext.setOnClickListener(new C08621());
        this.footerBtnPrev.setOnClickListener(new C08632());
        return view;
    }
    ...
    protected void displayResultsSummary() {
        int resid = C0815R.string.Search_Label_Results;
        if (this.numTotalResults <= 0) {
            resid = C0815R.string.Search_Label_ResultsNone;
        } else if (this.numCurrentResults == this.numTotalResults) {
            resid = C0815R.string.Search_Label_ResultsAll;
        }
    ...
    protected void displayInProgress() {
        this.progressLabel.setText(C0815R.string.Search_Label_Searching);
        this.progressLabel.setVisibility(0);
    }
