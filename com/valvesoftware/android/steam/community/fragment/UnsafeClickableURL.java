...
public class UnsafeClickableURL extends URLSpan {
    ...
    public void onClick(View v) {
        if (this.m_bShowUnsafeWarning) {
            ...
            builder.setTitle(C0815R.string.nonsteam_link_title);
            builder.setMessage(this.activity.getString(C0815R.string.nonsteam_link_text) + "\n\n" + getURL());
            builder.setPositiveButton(C0815R.string.nonsteam_link_ok, new OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    UnsafeClickableURL.this.HandleUserProcceedSelected(finalView);
                }
            });
            builder.setNegativeButton(C0815R.string.Cancel, null);
            builder.create().show();
            return;
        }
