...
public class ChatViewAdapter extends ArrayAdapter<UmqMessage> {
    ...
    private final Comparator<UmqMessage> messageOrderComparator = new C08761();

    class C08761 implements Comparator<UmqMessage> {
            ...
            public boolean onLongClick(View v) {
                try {
                    ...
                    if (clipBoard != null && (v instanceof TextView)) {
                        ...
                        Toast toast = Toast.makeText(activity, C0815R.string.notification_chat_copied, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = this.m_layoutInflater.inflate(C0815R.layout.chat_simple_entry, null);
            holder = new ChatViewHolder();
            holder.chatPartnerLayoutContainer = convertView.findViewById(C0815R.id.chat_partner_layout);
            holder.loggedInUserLayoutContainer = convertView.findViewById(C0815R.id.chat_logged_in_user_layout);
            holder.chatPartnerAvatar = (NetworkImageView) convertView.findViewById(C0815R.id.avatar_chat_partner);
            holder.chatPartnerTextView = (TextView) convertView.findViewById(C0815R.id.chat_text_chat_partner);
            holder.loggedInUserTextView = (TextView) convertView.findViewById(C0815R.id.chat_text_logged_in_user);
            holder.extraPaddingView = convertView.findViewById(C0815R.id.extra_padding);
            holder.loggedInUserTimestampTextView = (TextView) convertView.findViewById(C0815R.id.chat_text_logged_in_user_timestamp);
            holder.chatPartnerTimestampTextView = (TextView) convertView.findViewById(C0815R.id.chat_text_partner_timestamp);
            holder.chatPartnerTextView.setOnLongClickListener(this.m_longClickHandler);
            holder.sendErrorTextView = (TextView) convertView.findViewById(C0815R.id.chat_text_send_error);
