...
public class LoginFragment extends Fragment {
    ...
    class C09061 implements OnLayoutChangeListener {
        C09061() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(C0815R.layout.login, container, false);
        this.twoFactorCodeListView = (TwoFactorCodeListView) view.findViewById(C0815R.id.login_twofactor_view);
        this.steamWebView = (SteamWebView) view.findViewById(C0815R.id.webview);
        this.steamWebView.setOwner(this);
        if (VERSION.SDK_INT >= 11) {
            this.steamWebView.addOnLayoutChangeListener(new C09061());
        }
        loadPage();
        return view;
    }
