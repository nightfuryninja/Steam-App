...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C00942();
    private final Runnable mMenuInvalidator = new C00931();
    ...
    class C00942 implements OnMenuItemClickListener {
        C00942() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0098R.layout.abc_list_menu_item_layout);
