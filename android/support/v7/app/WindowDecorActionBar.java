...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C00951();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C00962();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<Object> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C00973();

    class C00951 extends ViewPropertyAnimatorListenerAdapter {
        C00951() {
        }
    ...
    class C00962 extends ViewPropertyAnimatorListenerAdapter {
        C00962() {
        }
    ...
    class C00973 implements ViewPropertyAnimatorUpdateListener {
        C00973() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0098R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0098R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0098R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0098R.id.action_bar_container);
        ...
        abp.enableHomeButtonByDefault();
        setHasEmbeddedTabs(abp.hasEmbeddedTabs());
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0098R.styleable.ActionBar, C0098R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0098R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0098R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0098R.attr.actionBarWidgetTheme, outValue, true);
