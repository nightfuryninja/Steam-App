...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C01292 implements OnGlobalLayoutListener {
            C01292() {
            }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ...
                if (vto != null) {
                    final OnGlobalLayoutListener layoutListener = new C01292();
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0098R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0098R.styleable.Spinner, defStyleAttr, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C0098R.styleable.Spinner_popupTheme, 0);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == 1) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0098R.styleable.Spinner, defStyleAttr, 0);
                this.mDropDownWidth = pa.getLayoutDimension(C0098R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0098R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0098R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
        ...
        CharSequence[] entries = a.getTextArray(C0098R.styleable.Spinner_android_entries);
        if (entries != null) {
            SpinnerAdapter adapter = new ArrayAdapter(context, 17367048, entries);
            adapter.setDropDownViewResource(C0098R.layout.support_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
        a.recycle();
        this.mPopupSet = true;
