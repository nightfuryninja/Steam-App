...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0098R.attr.actionBarSize, 16842841};
    ...
    class C01221 extends ViewPropertyAnimatorListenerAdapter {
        C01221() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01221();
        this.mRemoveActionBarHideOffset = new C01232();
        this.mAddActionBarHideOffset = new C01243();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0098R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0098R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0098R.id.action_bar));
        }
    }
