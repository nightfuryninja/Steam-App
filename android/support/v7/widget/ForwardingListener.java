...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01311 implements OnAttachStateChangeListener {
        C01311() {
        }
    ...
    class C01322 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01311());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01322());
    }
