...
final class RegisteredMediaRouteProvider extends MediaRouteProvider implements ServiceConnection {
    ...
    private final class Connection implements DeathRecipient {
        ...
        class C01102 implements Runnable {
            C01102() {
            }
        ...
        public void dispose() {
            ...
            RegisteredMediaRouteProvider.this.mPrivateHandler.post(new C01091());
        }
        ...
        public void binderDied() {
            RegisteredMediaRouteProvider.this.mPrivateHandler.post(new C01102());
        }
