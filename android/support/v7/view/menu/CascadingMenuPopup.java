...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C01151();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C01172();
    ...
    class C01151 implements OnGlobalLayoutListener {
        C01151() {
        }
    ...
    class C01172 implements MenuItemHoverListener {
        C01172() {
        }
    ...
    public CascadingMenuPopup(Context context, View anchor, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0098R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            View titleItemView = (FrameLayout) inflater.inflate(C0098R.layout.abc_popup_menu_header_item_layout, listView, false);
