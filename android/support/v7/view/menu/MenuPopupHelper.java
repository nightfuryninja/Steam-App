...
public class MenuPopupHelper {
    ...
    class C01191 implements OnDismissListener {
        C01191() {
        }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly, int popupStyleAttr, int popupStyleRes) {
        ...
        this.mInternalOnDismissListener = new C01191();
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(displaySize.x, displaySize.y) >= this.mContext.getResources().getDimensionPixelSize(C0098R.dimen.abc_cascading_menus_min_smallest_width)) {
